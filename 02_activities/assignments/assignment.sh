...
cd ..
cd raw
cp ./*server*.log ~/newproject/data/processed/server_logs
# 6. Repeat the above step for user logs and event logs
cp ./*user*.log ~/newproject/data/processed/user_logs
cp ./*event*.log ~/newproject/data/processed/event_logs
